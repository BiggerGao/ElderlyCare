...
//    NSLog(@"%@",self.selectedDate);
    ...
    [detailDict setObject:[NSString stringWithFormat:@"%d%.2d%.2d",lunarCalendar.GregorianYear,lunarCalendar.GregorianMonth,lunarCalendar.GregorianDay] forKey:@"GregorianDate"];
...
-(void)markDates:(NSArray *)dates {
    ...
    for (int i = 0; i<[dates count]; i++) {
        [colors addObject:[UIColor jzzColorWithHexString:@"0x079700"]];
    }
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i =0; i<[weekdays count]; i++) {
        ...
        {
            CGContextSetFillColorWithColor(context,
                                           [UIColor jzzColorWithHexString:@"0xff3333"].CGColor);
        }
        else
        {
            CGContextSetFillColorWithColor(context,
                                           [UIColor jzzColorWithHexString:@"0x383838"].CGColor);
        }
...
//        [weekdayValue drawInRect:CGRectMake(i*(kVRGCalendarViewDayWidth+2), 40, kVRGCalendarViewDayWidth+2, 20) withAttributes:@{@"NSForegroundFont":font, @"NSLineBreakMode":NSLineBreakByClipping, @"UITextAlignment": NSTextAlignmentCenter}];
    ...
    CGContextSetFillColorWithColor(context, [UIColor jzzColorWithHexString:@"0xf3f3f3"].CGColor);
    ...
    //Grid dark lines
    CGContextSetStrokeColorWithColor(context, [UIColor jzzColorWithHexString:@"0xcfd4d8"].CGColor);
    CGContextBeginPath(context);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        { //previous month
            ...
            {
                CGContextSetFillColorWithColor(context,
                                           [UIColor jzzColorWithHexString:@"0xf39999"].CGColor);
            }
            else
            {
                CGContextSetFillColorWithColor(context,
                                               [UIColor jzzColorWithHexString:hex].CGColor);
            }
        ...
        if (selectedDate && i==selectedDateBlock) {
            ...
            CGContextAddRect(context, rectangleGrid);
            CGContextSetFillColorWithColor(context, [UIColor jzzColorWithHexString:@"0x006dbc"].CGColor);
            CGContextFillPath(context);
            ...
            CGRect rectangleGrid = CGRectMake(targetX,targetY,kVRGCalendarViewDayWidth+2,kVRGCalendarViewDayHeight+2);
            CGContextAddRect(context, rectangleGrid);
            CGContextSetFillColorWithColor(context, [UIColor jzzColorWithHexString:@"0x383838"].CGColor);
            CGContextFillPath(context);
...
-(id)init {
    ...
    if (self) {
        ...
        isAnimating=NO;
        labelCurrentMonth = [[UILabel alloc] initWithFrame:CGRectMake(34, 0, kVRGCalendarViewWidth-68, 20)];
        ...
        labelCurrentMonth.textColor = [UIColor jzzColorWithHexString:@"0x383838"];
