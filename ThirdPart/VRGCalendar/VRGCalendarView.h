...
#define kVRGCalendarViewDayWidth (([UIScreen mainScreen].bounds.size.width - 10 )/7)
#define kVRGCalendarViewDayHeight (([UIScreen mainScreen].bounds.size.height - 10 )/11)
